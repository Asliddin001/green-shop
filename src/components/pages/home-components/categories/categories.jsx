...
export const Categories = () => {
  ...
  return (
    <div className="container mt-[45px] flex gap-[50px]">
      <div className="bg-grey text-black w-1/4 px-[18px] py-[14px]">
        ...
        <div className="size">
          <h2 className="text-gray-700 font-cera-pro font-bold text-xl leading-5 mb-[7px]">
            Size
          </h2>
          <ul>
            {["Small", "Medium", "Large"].map((size, index) => (
              <li key={index} className="mb-2 ml-4">
                <div className="group dfrowc justify-between hover:text-green hover:font-bold transition-all duration-300">
                  <span className="text-gray-700 font-cera-pro text-base font-normal leading-[40px]">
                    {size}
                  </span>
                  <span className="text-gray-700 font-cera-pro text-base font-normal leading-[40px]">
                    (78)
      ...
      <main className="w-full dfcol">
        <div className="dfrowc justify-between mb-[31px]">
          ...
          <div className="flex items-center">
            ...
            <select className="p-2 border border-gray-300 border-none">
        ...
        <div className="pagination mt-[90px] dfrowc justify-end gap-[10px]">
          {Array.from({ length: totalPages }).map((_, index) => (
            <button
              className="w-[35px] h-[35px] dfrowc justify-center py-[11px] px-[14px] focus:bg-green rounded-[4px] text-black border-grey-3 border-[1px] focus:text-white transition-all duration-300 ease-in-out"
              key={index}
